...
//      private final PhotonPoseEstimator photonPoseEstimator1 = new PhotonPoseEstimator(kFieldLayout, PoseStrategy.LOWEST_AMBIGUITY, kRobotToMod1CameraTransform);
//      private final PhotonPoseEstimator photonPoseEstimator2 = new PhotonPoseEstimator(kFieldLayout, PoseStrategy.LOWEST_AMBIGUITY, kRobotToMod2CameraTransform);
...
// /*vision constructor */      
//  public Vision(/*DrivetrainSubsystem drivetrainSubsys*/) {
...
//     // SmartDashboard.putNumber("mod 0 estimated pose x", 0.0);
...
// //  public double lastEstimateTimestampMod0 = 0.0;
...
// //          robotPose = photonPoseEstimator0.update(change);
// //      }

     
// //      lastEstimateTimestampMod0 = mod0Camera.getLatestResult().getTimestampSeconds();

// //      return robotPose;
// //  }
   
//  public double lastEstimateTimestampMod1 = 0.0;
...
//          robotPose = photonPoseEstimator1.update(change);
//      }

     
//      lastEstimateTimestampMod1 = mod1Camera.getLatestResult().getTimestampSeconds();

//      return robotPose;
//  }

//  public double lastEstimateTimestampMod2 = 0.0;
...
//          robotPose = photonPoseEstimator2.update(change);
//      }

     
//      lastEstimateTimestampMod2 = mod2Camera.getLatestResult().getTimestampSeconds();
...
//   //    if(getEstimatedPoseMod0().isPresent()){
//   //  // try{
//   //         getEstimatedPoseMod0();
//   //         SmartDashboard.putNumber("mod 0 estimated pose x", getEstimatedPoseMod0().get().estimatedPose.getX());
//   //    }else{
//   //     //} catch (Exception e) {
//   //        SmartDashboard.putNumber("mod 0 estimated pose x", 0.0);
...
//      if(getEstimatedPoseMod1().isPresent()){
//        // try{
//               getEstimatedPoseMod1();
//               SmartDashboard.putNumber("mod 1 estimated pose x", getEstimatedPoseMod1().get().estimatedPose.getX());

//          }else{
//              SmartDashboard.putNumber("mod 1 estimated pose x", 0.0);
 
//              Commands.print("mod1 pose failed");
//          }

//          if(getEstimatedPoseMod2().isPresent()){
//            // try{
//                   getEstimatedPoseMod2();
//                   SmartDashboard.putNumber("mod 2 estimated pose x", getEstimatedPoseMod2().get().estimatedPose.getX());
//                  }else{
//               //} catch (Exception e) {
//                  SmartDashboard.putNumber("mod 2 estimated pose x", 0.0);
...
// //          if(getEstimatedPoseMod0().isPresent()){
// //               getEstimatedPoseMod0();
// //              // driveSubsys.addVisionMeasurement(getEstimatedPoseMod0().get().estimatedPose.toPose2d(), lastEstimateTimestampMod0);
// //          } else{
// //          // } catch (Exception e) {
// //              // mod0Pose2d = pose;
// //              Commands.print("mod0 pose failed");
...
// //         //  SmartDashboard.putNumber("mod 0 pose x", mod0Pose2d.getX());
// //           SmartDashboard.putNumber("mod 0 estimated pose x", getEstimatedPoseMod0().get().estimatedPose.getX());
...
// //      // SmartDashboard.putNumber("mod 1 pose x", mod1Pose2d.getX());
// //      // SmartDashboard.putNumber("mod 2 estimated pose x", getEstimatedPoseMod1(pose).get().estimatedPose.getX());
...
// //   update();
// //   visionSim.update(drivetrainSubsys.getState().Pose);
// // }

// // public void updatePose(){
// // // if(vision.getEstimatedPoseMod0().isPresent()){
// //     try{
// //       drivetrainSubsys.addVisionMeasurement(getEstimatedPoseMod0().get().estimatedPose.toPose2d(), lastEstimateTimestampMod0);
// //        //}else{
// //       } catch (Exception e) {
// //          Commands.print("mod0 pose failed");
// //      }
// //       // if(vision.getEstimatedPoseMod0().isPresent()){
// //        try{
// //          drivetrainSubsys.addVisionMeasurement(getEstimatedPoseMod1().get().estimatedPose.toPose2d(), lastEstimateTimestampMod1);
// //           //}else{
// //          } catch (Exception e) {
// //             Commands.print("mod1 pose failed");
// //         }
// //         // if(vision.getEstimatedPoseMod0().isPresent()){
// //     try{
// //      drivetrainSubsys.addVisionMeasurement(getEstimatedPoseMod2().get().estimatedPose.toPose2d(), lastEstimateTimestampMod2);
// //       //}else{
// //      } catch (Exception e) {
// //         Commands.print("mod2 pose failed");
// //     }
